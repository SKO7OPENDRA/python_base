...
def withdraw_money(person, money):
    if money <= 0:
        return 'Вы указали некорректную сумму для снятия!'
    elif person['money'] - money >= 0:
        person['money'] -= money  # person['money'] =  person['money'] - money
...
def process_user_choice(choice, person):
    if choice == 1:
        ...
        try:
            ...
            print('Указана некорректная сумма!')
...
def start():
    try:
        ...
        print('Вы ввели некорректные номер карты или пин.')
        return
